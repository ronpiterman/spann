...
public class TestLazy extends BaseTestMetadata {
    ...
    public TestLazy() {
        ...
        setLazyLoadingRulesFactory( new LazyLoadingRulesFactoryImpl() );
    }
    ...
    public void testLazyOff() {
        ...
        Assert.assertEquals( cm.getFields().size() , 18 );
        Assert.assertEquals( cm.getMethods().size() , 7 );
