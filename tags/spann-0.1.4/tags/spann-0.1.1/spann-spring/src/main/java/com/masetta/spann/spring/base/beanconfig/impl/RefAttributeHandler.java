...
public class RefAttributeHandler implements AttributeHandler {
	...
	public void handle(AnnotatedElementMetadata metadata, ScanContext context,
		...
		String beanName = annotation.getAttribute( String.class, name , true );
		DefSupport.setProperty( beanDefinition , name , new RuntimeBeanReference( beanName ) );
	}
